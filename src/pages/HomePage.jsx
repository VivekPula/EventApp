...
const HomePage = ()=>{
    ...
    return (
        <div
            style={{color:Mtheme.fg,backgroundColor:Mtheme.bg}}
        >
        <div className="w-full mt-2 flex p-1"> 
            <div className="flex items-center text-xl min-w-1/10 justify-center font-semibold" style={{color:theme.accentColor(1)}}>Filters</div>
