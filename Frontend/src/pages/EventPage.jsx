        ...
        <div className=" w-full h-full flex gap-5 mx-5 pt-4" >
            ...
            <div className="ml-auto mr-auto w-15/16 ">
                ...
                <div className="flex flex-wrap">
                    <p className="text-xl mt-2 flex-1/2 "><span className="font-semibold text-(--primaryColor)" >Conducted by :</span> by person {data.Slots} </p>
                    <p className="text-xl mt-2 flex-1/2 "><span className="font-semibold text-(--primaryColor)" >Type :</span> {x}</p>
                    <p className="text-xl mt-2 flex-1/2 "><span className="font-semibold text-(--primaryColor)" >Contributors :</span> {data.Slots} people</p>
                    <p className="text-xl mt-2 flex-1/2 "><span className="font-semibold text-(--primaryColor)" >Volunteers :</span> {data.Slots} people</p>
                    <p className="text-xl mt-2 flex-1/2 "><span className="font-semibold text-(--primaryColor)" >Availabe slots :</span> {data.Slots} </p>
                    <p className="text-xl mt-2 flex-1/2 "><span className="font-semibold text-(--primaryColor)" >Location :</span> {data.Location} at that location</p>
                </div>
            </div>
            ...
            <div className="flex-1">
                <div className=" sticky top-24 p-2  rounded-2xl bg-(--primaryColor)/10 darkMode:bg-(--accentColor)/60" >
                    ...
                    <div className="flex flex-col gap-5 mt-4 ml-4 text-xl">
                        ...
                        <p className="flex gap-2 items-center"> <Clock className="text-(--accentColor) darkMode:text-(--exColor)/80"/> : {data.Slots} pm</p>
                        ...
                        <p className="flex gap-2 items-center"> <Grid3x2 className="text-(--accentColor) darkMode:text-(--exColor)/80"/> : {data.Category}</p>
                        <p className="flex gap-2 items-center"> <MapPin className="text-(--accentColor) darkMode:text-(--exColor)/80"/> : {data.Location}</p>
                        <p className="flex gap-2 items-center"> <Ticket className="text-(--accentColor) darkMode:text-(--exColor)/80"/> : {data.Slots}</p>
                    </div>
