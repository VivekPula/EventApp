        ...
        itemRenderer={({ item, methods, state }) => {
          ...
          return (
            <div
              className={
                isSelected
                  ? "p-2 m-1 rounded-xl bg-(--primaryColor)/20 darkMode:text-black darkMode:bg-(--secondaryColor)"
                  : "p-2 m-1 rounded-xl bg-white darkMode:bg-(--primaryColor)/50 darkMode:text-white"
              }
