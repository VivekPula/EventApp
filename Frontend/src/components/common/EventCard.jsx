      ...
      <Link to={`/${page}/event/${item._id}`}>
        ...
        <div className="m-2 relative flex h-6/10 rounded-3xl overflow-clip items-center justify-center">
          <div className="flex absolute z-10 top-2 right-1">
            <p className="flex mr-2 font-semibold items-center rounded-xl pl-2 pr-2 bg-(--secondaryColor) darkMode:bg-(--exColor)/90 text-(--primaryColor) darkMode:text-(--primaryColor) ">
              {item.category}
            </p>
          </div>
          <img
        ...
        <div className="m-2   pl-2">
          <div className="flex w-full justify-start ">
            <p className="font-semibold text-2xl w-2/3 font-serifs mr-auto text-black darkMode:text-(--exColor) line-clamp-1">
              {item.title}
            </p>
            <p className="mr-2 text-center mt-1 w-1/3">{item.date}</p>
          </div>{" "}
          ...
          <div className="flex w-full justify-start">
            ...
            <p className="flex mr-2 mt-2 font-semibold items-center gap-2">
              <Ticket
                className=" text-(--primaryColor) darkMode:text-(--exColor)"
                size={30}
              />{" "}
